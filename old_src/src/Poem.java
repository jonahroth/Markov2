...
public class Poem {
    ...
    public Poem(MeterIndex mind, RhymeIndex rind) {
        this.mind = mind;
        this.rind = rind;
    ...
    public Poem(MeterIndex mind, RhymeIndex rind, String newScheme) {
        this.mind = mind;
        this.rind = rind;
        scheme = newScheme;
        meter = "0101010101";
    ...
    }  public Poem(MeterIndex mind, RhymeIndex rind, String newScheme, String newMeter) {
        this.mind = mind;
        this.rind = rind;
        scheme = newScheme;
        meter = newMeter;
